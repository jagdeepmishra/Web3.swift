...
[![CocoaPods Compatible](https://img.shields.io/cocoapods/v/PPCryptoSwift.svg?style=flat&label=CocoaPods&colorA=28a745&&colorB=4E4E4E)](https://cocoapods.org/pods/PPCryptoSwift)
...
[Why?](https://github.com/krzyzanowskim/PPCryptoSwift/issues/5) [Because I can](https://github.com/krzyzanowskim/PPCryptoSwift/issues/5#issuecomment-53379391).
...
Check out [CONTRIBUTING.md](CONTRIBUTING.md) for more information on how to help with PPCryptoSwift.

- If you found a bug, [open an issue](https://github.com/krzyzanowskim/PPCryptoSwift/issues).
- If you have a feature request, [open an issue](https://github.com/krzyzanowskim/PPCryptoSwift/issues).

## Installation

To install PPCryptoSwift, add it as a submodule to your project (on the top level project directory):

    git submodule add https://github.com/krzyzanowskim/PPCryptoSwift.git
...
Embedded frameworks require a minimum deployment target of iOS 8 or OS X Mavericks (10.9). Drag the `PPCryptoSwift.xcodeproj` file into your Xcode project, and add appropriate framework as a dependency to your target. Now select your App and choose the General tab for the app target. Find _Embedded Binaries_ and press "+", then select `PPCryptoSwift.framework` (iOS, OS X, watchOS or tvOS)
...
- Swift 1.2: branch [swift12](https://github.com/krzyzanowskim/PPCryptoSwift/tree/swift12) version <= 0.0.13
- Swift 2.1: branch [swift21](https://github.com/krzyzanowskim/PPCryptoSwift/tree/swift21) version <= 0.2.3
- Swift 2.2, 2.3: branch [swift2](https://github.com/krzyzanowskim/PPCryptoSwift/tree/swift2) version <= 0.5.2
- Swift 3.1, branch [swift3](https://github.com/krzyzanowskim/PPCryptoSwift/tree/swift3) version <= 0.6.9
- Swift 3.2, branch [swift32](https://github.com/krzyzanowskim/PPCryptoSwift/tree/swift32) version = 0.7.0
- Swift 4.0, branch [swift4](https://github.com/krzyzanowskim/PPCryptoSwift/tree/swift4) version <= 0.12.0
- Swift 4.2, branch [swift42](https://github.com/krzyzanowskim/PPCryptoSwift/tree/swift42) version <= 0.15.0
- Swift 5.0, branch [master](https://github.com/krzyzanowskim/PPCryptoSwift/tree/master)

#### CocoaPods

You can use [CocoaPods](http://cocoapods.org/?q=PPCryptoSwift).
...
```ruby
pod 'PPCryptoSwift', :git => "https://github.com/krzyzanowskim/PPCryptoSwift", :branch => "master"
```

Bear in mind that CocoaPods will build PPCryptoSwift without [Whole-Module Optimization](https://swift.org/blog/whole-module-optimizations/) that may impact performance. You can change it manually after installation, or use [cocoapods-wholemodule](https://github.com/jedlewison/cocoapods-wholemodule) plugin.
...
```ruby
github "krzyzanowskim/PPCryptoSwift"
```

Run `carthage` to build the framework and drag the built PPCryptoSwift.framework into your Xcode project. Follow [build instructions](https://github.com/Carthage/Carthage#getting-started). [Common issues](https://github.com/krzyzanowskim/PPCryptoSwift/issues/492#issuecomment-330822874).
...
```swift
dependencies: [
    .package(url: "https://github.com/krzyzanowskim/PPCryptoSwift.git", .upToNextMinor(from: "1.0.0"))
]
```
...
```swift
dependencies: [
    .package(url: "https://github.com/krzyzanowskim/PPCryptoSwift.git", .exact("1.0.0"))
]
```
...
also check [Playground](/PPCryptoSwift.playground/Contents.swift)
...
PPCryptoSwift uses array of bytes aka `Array<UInt8>` as a base type for all operations. Every data may be converted to a stream of bytes. You will find convenience functions that accept `String` or `Data`, and it will be internally converted to the array of bytes.

##### Data types conversion

For your convenience, **PPCryptoSwift** provides two functions to easily convert an array of bytes to `Data` or `Data` to an array of bytes:
...
Notice regarding padding: _Manual padding of data is optional, and PPCryptoSwift is using PKCS7 padding by default. If you need to manually disable/enable padding, you can do this by setting parameter for **AES** class_
...
See [Playground](/PPCryptoSwift.playground/Contents.swift) for sample code that work with stream.
...
PPCryptoSwift is owned and maintained by [Marcin Krzyżanowski](http://www.krzyzanowskim.com)
